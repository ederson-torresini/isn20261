...
INSTALL_JS_GLOBAL="/home/aluno/Downloads/isn20261/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/aluno/Downloads/isn20261/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
