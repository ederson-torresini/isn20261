...
```bash
INIT=$(node "/home/aluno/Downloads/isn20261/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/aluno/Downloads/isn20261/.claude/get-shit-done/templates/spec.md.
