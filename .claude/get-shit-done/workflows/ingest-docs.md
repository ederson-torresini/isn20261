...
```bash
INIT=$(node "/home/aluno/Downloads/isn20261/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/aluno/Downloads/isn20261/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
