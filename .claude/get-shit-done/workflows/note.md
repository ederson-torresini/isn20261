...
- **Global scope**: `/home/aluno/Downloads/isn20261/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/aluno/Downloads/isn20261/.claude/notes/`)
...
2. Glob `/home/aluno/Downloads/isn20261/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/aluno/Downloads/isn20261/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/aluno/Downloads/isn20261/.claude/notes/` — works in any directory
