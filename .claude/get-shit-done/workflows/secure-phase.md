...
```
Task(
  prompt="Read /home/aluno/Downloads/isn20261/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/aluno/Downloads/isn20261/.claude/get-shit-done/templates/SECURITY.md`
